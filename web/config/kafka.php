...
return [
     ...
     */
    'brokers' => env('KAFKA_BROKERS', 'b-1-public.clustertest.1xd1q5.c13.kafka.us-west-2.amazonaws.com:9196, b-2-public.clustertest.1xd1q5.c13.kafka.us-west-2.amazonaws.com:9196'),
     ...
     */
    'sasl' => [
        'username' => env('KAFKA_SASL_USERNAME', 'fgamboa'),
        'password' => env('KAFKA_SASL_PASSWORD', 'fgamboa')
    ],
